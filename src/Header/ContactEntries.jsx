        ...
        <div className="space-y-6">
          {contacts.map((contact) => (
            ...
            >
              ...
              <p>
                <span className="text-indigo-300">Phone:</span> {contact.phone}
              </p>
              {contact.alternatePhone && (
                <p>
                  <span className="text-indigo-300">Alt Phone:</span>{" "}
                  {contact.alternatePhone}
                </p>
              )}
              <p>
                <span className="text-indigo-300">Subject:</span>{" "}
                {contact.subject}
              </p>
              <p>
                <span className="text-indigo-300">DOB:</span> {contact.dob}
              </p>
              <p>
